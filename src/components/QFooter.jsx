        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-600 hover:text-black transition-colors duration-200">Q by Aston Martin</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-600 hover:text-black transition-colors duration-200">Find a Dealer</a></li>
              <li><a href="#" className="text-gray-600 hover:text-black transition-colors duration-200">Q Specialists</a></li>
